...
2026-09-05 · feature/toilet-seo-projection · 운영 미배포.
...
검증: MockMvc의 익명 요청·ID-only JSON·입력 오류, CI disposable MySQL 8.0에서 sparse ID/경계/삭제/빈 데이터/1만 건 상한과 EXPLAIN PK range 검사. 운영 MySQL 성능과 전체 건수 대조는 아직 수행하지 않았다.
