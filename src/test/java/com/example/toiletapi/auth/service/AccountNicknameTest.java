...
class AccountNicknameTest {
    ...
    final AccountService service = new AccountService(users, null, null, null, null, null, null, new AccountLifecycleGate(true, false, false), null, mock(com.example.toiletapi.photo.PhotoService.class));
