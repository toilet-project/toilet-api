...
public record ToiletReportResponse(Long id, Long toiletId, String toiletName, String reportType, BigDecimal latitude, BigDecimal longitude, String roadAddress, String openTime, String reason, String status, String reviewNote, LocalDateTime createdAt, LocalDateTime reviewedAt) {
