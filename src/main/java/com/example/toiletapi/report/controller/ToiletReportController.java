...
public class ToiletReportController {
    ...
    @GetMapping("/api/admin/v1/reports/search") public ToiletReportPageResponse pendingPage(@RequestParam(defaultValue = "") String keyword,
                                                                                               @RequestParam(defaultValue = "0") int page,
                                                                                               @RequestParam(defaultValue = "20") int size) { return service.pendingPage(keyword, page, size); }
